...
class Game:
    ...
    def throw_randomly(self, rounds, users):
        for user in users:
    ...
    def swap_the_cards(self, rounds, users):
        temp = []
        self.deep_copy(temp, users[3].user_drawn_cards[rounds])
        users[3].user_drawn_cards[rounds] = []
        self.deep_copy(users[3].user_drawn_cards[rounds], users[2].user_drawn_cards[rounds])
        users[2].user_drawn_cards[rounds] = []
        self.deep_copy(users[2].user_drawn_cards[rounds], users[1].user_drawn_cards[rounds])
        users[1].user_drawn_cards[rounds] = []
        self.deep_copy(users[1].user_drawn_cards[rounds], users[0].user_drawn_cards[rounds])
        users[0].user_drawn_cards[rounds] = []
        self.deep_copy(users[0].user_drawn_cards[rounds], temp)
        
    def calculate_points(self):
        for i in range(3):
            self.soya_sauce_calculator(i, self.users)
    ...
    def reveal_the_winner(self, users):
        winners = {}
